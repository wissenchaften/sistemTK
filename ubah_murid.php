...
<body>
    <div class="container bg-light shadow">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label for="namaMurid">Nama Murid : </label><input name="namaMurid" type="text" id="namaMurid"
                    class="form-control" value="<?= $murid["nama_murid"] ?>" required>
            </div>
            <div class="form-group">
                <label for="namaWaliMurid">Nama Wali Murid : </label><input name="namaWaliMurid" type="text"
                    id="namaWaliMurid" class="form-control" value="<?= $murid["nama_wali_murid"]; ?>" required>
            </div>
            <div class="form-group">
                <label for="kelasMurid">Kelas : </label><input name="kelasMurid" type="text" id="kelasMurid"
                    class="form-control" value="<?= $murid["kelas_murid"]; ?>" required>
            </div>
            <div class="form-group">
                <label for="tglLahir">Tanggal Lahir : </label><input name="tglLahir" type="date" id="tglLahir"
                    class="form-control w-25" value="<?= $murid["tgl_lahir_murid"]; ?>" required>
            </div>
            <div class="form-check-inline">
                <input name="jk" type="radio" id="jkL" class="form-check-input" value="1"
                    <?= $murid['jk_murid'] == 1 ? "checked":"" ?>>
                <label class="form-check-label" for="jkL">Laki - laki</label>
            </div>
            <div class="form-check-inline">
                <input name="jk" type="radio" id="jkP" class="form-check-input" value="0"
                    <?= $murid['jk_murid'] == 0 ? "checked":"" ?>>
                <label class="form-check-label" for="jkP">Perempuan</label>
            </div>
            <div class="form-group">
                <label for="alamat">Alamat : </label><input name="alamat" type="text" id="alamat" class="form-control"
                    value="<?= $murid["alamat_murid"]; ?>" required>
            </div>
            <div class="form-group">
                <label for="noHpMurid">No.Handphone : </label><input name="noHpMurid" type="text" id="noHpMurid"
                    class="form-control" value="<?= $murid["no_hp_murid"]; ?>" required>
            </div>
            <div class="form-group">
                <label for="tahunMasuk">Tahun Masuk : </label><input name="tahunMasuk" type="text" id="tahunMasuk"
                    class="form-control" value="<?= $murid["tahun_masuk_murid"]; ?>" required>
            </div>
            <div class="form-group">
                <label for="emailMurid">Email Murid : </label><input name="emailMurid" type="email" id="emailMurid"
                    class="form-control" value="<?= $murid["email_murid"]; ?>" required>
            </div>
            <div class="form-group">
